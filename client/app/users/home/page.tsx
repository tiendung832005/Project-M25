        ...
        <div className="contact">
          ...
          <div className="cart">
            <Link href="/users/profile">
              ...
              {userName ? <h1>Xin chào, {userName}!</h1> : null}
            </Link>
            {/* Đăng xuất sẽ chỉ hiển thị nếu người dùng đã đăng nhập */}
            {userName && (
              <Link
                href="/users/login"
                ...
                onClick={() => {
                  ...
                  setUserName(""); // Cập nhật lại state để ẩn tên người dùng
                }}
              >
                Đăng xuất
              </Link>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-0">
          <div>
            ...
            <p className="text-gray-700">
              Chúng tôi được tạo ra với mục đích mang lại thật nhiều điều tích
              cực cho cộng đồng những người yêu bóng đá trên toàn đất nước Việt
              Nam. Với chất lượng sản phẩm cùng dịch vụ chăm sóc khách hàng kỹ
              lưỡng, tỉ mỉ, Vua Áo Bóng Đá hi vọng sẽ là một địa chỉ đáng tin
              cậy dành cho tất cả các anh em yêu bóng đá.
            </p>
          ...
          <div>
            ...
            <div className="text-gray-700">
              ...
              <p>
                Theo dõi chúng tôi trên Facebook để cập nhật các tin tức mới
                nhất!
              </p>
